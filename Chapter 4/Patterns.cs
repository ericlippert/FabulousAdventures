...
interface IPattern
{
    void Add(ILife life, QuadPoint corner);
}
...
sealed class PlaintextPattern : IPattern
{
    ...
    public void Add(ILife life, QuadPoint corner)
    {
...
$408b2o!");
    ...
    public static void AddPattern(this ILife life, QuadPoint corner, IPattern pattern)
    {
